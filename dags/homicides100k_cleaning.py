...
def clean_remesas_dataset():
    input_file_path = '/usr/local/airflow/dags/datasets/homicides100k.csv'
    output_file_path = '/usr/local/airflow/dags/datasets-cleaning/homicides100k-cleaning.csv'
...
with DAG('cleaning_homicides_dag', start_date=datetime(2023, 5, 11), schedule_interval=None) as dag:
    clean_task = PythonOperator(
        task_id='clean_remesas_dataset',
